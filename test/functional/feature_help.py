...
"""Verify that starting japancoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start japancoin with -h for help text")
        ...
        self.log.info("Start japancoin with -version for version information")
        ...
        self.log.info("Start japancoind with -fakearg to make sure it does not start")
