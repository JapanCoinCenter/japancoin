...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " japancoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  japancoin-tx [options] <hex-tx> [commands]  Update hex-encoded japancoin transaction\n" +
            "or:     japancoin-tx [options] -create [commands]   Create hex-encoded japancoin transaction\n" +
            "\n";
