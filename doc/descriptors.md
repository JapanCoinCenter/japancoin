# Support for Output Descriptors in JapanCoin Core

Since JapanCoin Core v0.17, there is support for Output Descriptors. This is a
...
on JapanCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing JapanCoin Core wallets, a convenience function `combo` is
